...
const TalentSection = () => {
  ...
  const [accordionClass, setAccordionClass] = useState("accordion-text");
    ...
    <section className="talent-section wrapper">
      <div className="talent-left">
        ...
        <div className="accordion-container acc-cont-1">
          <div className="accordion-header" onClick={updateAccordion}>
            <h4>Seamless search</h4>
            {!isHeaderClicked ? <img src={DownArrow} alt="" /> : <img src={UpArrow} alt="" />}
          </div>
